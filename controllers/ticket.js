...
export const createTicket = async (req, res) => {
    try {
        ...
        return res.status(201).json({message: "Ticket created and processing started successfully", ticket: newTicket});
    } catch (error) {
        console.log(error);
        return res.status(500).json({error: "Failed to create ticket and process it", details: error.message});
